...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS GOODS (Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, price VARCHAR, image BLOG)");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_GALLERY){
            if (grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(getApplicationContext(), "Kamu tidak memiliki izin untuk mengakses lokasi file !",Toast.LENGTH_SHORT).show();
            }
            return;
        }
